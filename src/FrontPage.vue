<template>
  <section class="hero">
    <div>
      <h1>Sensor-driven raised bed automation</h1>
      <p class="subtitle">
      ...
      -->
      <div class="cta">
        <a class="button" href="mailto:info@cornucopiamachines.eu">GET IN TOUCH</a>
        <form class="subscribe" @submit.prevent="onSubmit">
          <input
            v-model="email"
            type="email"
            inputmode="email"
  ...
  <q-card flat>
    ...
    <q-card-section>
      ...
      <ul>
        ...
        <li>
          Automates Task &amp; Fertigation Scheduling from bed map, weather data, and live
          sensors.
        </li>
        <li>
          Plug-and-Play Hardware &ndash; Solar-powered, connected, purpose-built for food
          growing.
        </li>
        <li>
