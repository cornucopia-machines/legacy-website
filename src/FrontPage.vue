<template>
  <section class="hero">
    <div>
      ...
      <div class="cta">
        <q-btn href="mailto:info@cornucopiamachines.eu" class="button" label="GET IN TOUCH" />
        <q-form class="subscribe" @submit.prevent="onSubmit">
          <q-input v-model="email" type="email" dense standout="bg" placeholder="Enter your email" aria-label="Email" :disable="submitting" />
          <q-btn type="submit" class="button secondary q-ml-sm" :loading="submitting" label="NOTIFY ME" data-umami-event="notify-me" />
  ...
  <q-card bordered flat class="q-mt-lg">
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <p class="q-mt-none">
        ...
        &ndash; but with a loyal subscriber base and a strong product pipeline for lasting
        revenue.
      </p>
    </q-card-section>
    <q-separator inset />
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <p class="q-mt-none">
        ...
        knowledge-dependent — especially when managing multiple crops in raised beds. Most
        solutions are either too simple, too DIY, or too complex.
      </p>
    </q-card-section>
    <q-separator inset />
    <q-card-section class="q-pt-md q-pb-sm">
    ...
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <ul>
        <li>Sensor-Based Irrigation &ndash; Adjusts to crop needs, mulch, and soil data &mdash; not timers.</li>
        <li>Environmental Alerts &ndash; Warns of conditions linked to crop stress or disease.</li>
        <li>Built-In Crop Intelligence &ndash; 50+ vegetables with root depth, fertility, and harvest logic.</li>
        <li>Automates Task &amp; Fertigation Scheduling from bed map, weather data, and live sensors.</li>
        <li>Plug-and-Play Hardware &ndash; Solar-powered, connected, purpose-built for food growing.</li>
        <li>Scalable Architecture &ndash; From single beds to orchards, livestock, and season extension.</li>
        <li>Beginner Support &ndash; Ready to use bed plans and guided growing content</li>
      </ul>
    </q-card-section>
    <q-separator inset />
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <ul>
        ...
        <li>Climate volatility and the home food movement create a perfect market inflection point</li>
      </ul>
    </q-card-section>
    <q-separator inset />
    <q-card-section class="q-pt-md q-pb-sm">
    ...
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <ul>
        <li><strong>Co-founders</strong> with hardware production, growth, or ops experience</li>
        <li><strong>Pre-seed investors</strong> to support hardware manufacturing, software rollout, and pilot</li>
        <li><strong>Pilot partners</strong> (urban farms, schools, homesteaders) for Q1 2026 deployment</li>
      </ul>
    </q-card-section>
  </q-card>
</template>
...
async function onSubmit() {
  ...
  try {
    const endpoint = (window as any).SUBSCRIBE_ENDPOINT || "https://formspree.io/f/xwpqapdd";
