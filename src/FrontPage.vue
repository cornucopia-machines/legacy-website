  ...
  <q-card bordered flat class="q-mt-lg">
    ...
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <ul>
        ...
        <li>
          Climate volatility and the home food movement create a perfect market inflection
          point
        </li>
      </ul>
    </q-card-section>
    ...
    <q-card-section class="q-pt-md q-pb-sm">
      ...
      <ul>
        <li>
          <strong>Co-founders</strong> with hardware production, growth, or ops experience
        </li>
        <li>
          <strong>Pre-seed investors</strong> to support hardware manufacturing, software
          rollout, and pilot
        </li>
        <li>
          <strong>Pilot partners</strong> (urban farms, schools, homesteaders) for Q1 2026
          deployment
        </li>
      </ul>
    </q-card-section>
